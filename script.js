...
function isCharAVowel(v) {
    if (v == 'a' || v == 'e' || v == 'o' || v == 'i' || v == 'u' || v == 'y') return true
    else return false
}
...
function greetUser(name, timeOfDay) {
    ...
    else return 'Invalid time of day'
}
...
function basicCalculator(num1, num2, operation) {
    ...
    else return 'invalid operation: must be (add, subtract, multiply, divide)'
}
...
function calculateGrade(grade) {
    ...
    else return 'Wrong grade, It should be a between 0-100'
...
function createUsername(fname, lname) {
    ...
    let username = fname.slice(0,3) + lname.slice(0,3) + (fullName.length-1);
    return username
}
